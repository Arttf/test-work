...
export function TaskTwoContent() {
  ...
  return (
    <section className="min-h-[640px] rounded-[28px] bg-[radial-gradient(circle_at_top,#f7f7fb_0%,#ececf3_45%,#e6e6ef_100%)] px-6 py-10 text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] md:px-10">
      ...
      <form className="mx-auto rounded-sm border border-slate-300 bg-white shadow-[0_8px_0_rgba(15,23,42,0.08),0_20px_35px_rgba(15,23,42,0.08)]">
        <section className="px-8 pb-6 pt-5">
          ...
          <div className="space-y-5">
            <div className="grid gap-3 lg:grid-cols-[1fr_2fr_1fr] lg:items-center">
        ...
        <section className="border-y border-yellow-200 bg-[#fff3b8] px-8 py-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
          ...
          <div className="grid gap-3 lg:grid-cols-[1fr_2fr_1fr]">
            ...
            <textarea
              className="min-h-[86px] w-full resize border border-slate-300 px-3 py-2 text-[1.15rem] leading-7 text-slate-700 outline-none placeholder:text-slate-500 focus:border-slate-400"
